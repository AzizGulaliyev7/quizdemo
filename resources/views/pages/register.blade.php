                ...
                <div class="leave-comment mr0"><!--leave comment-->
                    ...
                    {{csrf_field()}}
                        <div class="form-group">
                            <div class="col-md-12">
                                <input type="text" class="form-control" id="name" name="firstname" placeholder="Name" value="{{old('firstname')}}">
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="col-md-12">
                                <input type="text" class="form-control" id="name" name="lastname" placeholder="Name" value="{{old('lastname')}}">
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="col-md-12">
